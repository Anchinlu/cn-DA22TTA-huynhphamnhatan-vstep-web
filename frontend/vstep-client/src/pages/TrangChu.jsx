...
const TrangChu = () => {
  ...
  const skills = [
    ...
    { id: 'writing', title: 'Writing', desc: 'Trợ lí AI chấm điểm & sửa lỗi ngữ pháp', icon: PenTool, color: 'text-indigo-500', bg: 'bg-indigo-50', link: '/practice/writing' },
  ...
  const steps = [
    ...
    { num: '03', title: 'Nhận kết quả từ Trợ lí AI', desc: 'Xem điểm số và nhận xét chi tiết ngay lập tức.' }
  ];

  const testimonials = [
    { name: "Minh Anh", role: "Sinh viên ĐH QGHN", content: "Nhờ tính năng chấm Writing của Trợ lí AI mà mình đã nâng band điểm từ B1 lên B2 chỉ sau 2 tuần.", avatar: "M" },
            ...
            <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
              <Reveal direction="left">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-blue-300 text-sm font-semibold shadow-lg">
                  ...
                  <span>Công nghệ Trợ lí AI chấm thi VSTEP 2025</span>
                </div>
              </Reveal>
              ...
              <Reveal delay={800}>
                <div className="pt-8 flex items-center justify-center lg:justify-start gap-6 text-sm text-slate-400 font-medium">
                   ...
                   <div className="flex items-center gap-2"><CheckCircle2 size={16} className="text-green-400"/> Trợ lí AI chấm điểm</div>
                    ...
                    <div className="lg:w-1/2">
                        <Reveal direction="left">
                            <div className="relative">
                                ...
                                <img src="/img/writing.jpg" alt="Trợ lí AI Grading" className="relative rounded-3xl shadow-2xl w-full h-[400px] object-cover transform transition-transform hover:scale-[1.02] duration-500" />
                                ...
                                <div className="absolute bottom-8 right-8 bg-white p-6 rounded-2xl shadow-xl max-w-xs animate-bounce-slow hidden sm:block">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <span className="font-bold text-slate-800">Phân tích bởi Trợ lí AI</span>
                                    </div>
                    ...
                    <div className="lg:w-1/2 space-y-8">
                        <Reveal direction="right">
                            ...
                            <h2 className="text-4xl font-black text-slate-900 leading-tight mt-4">
                                Chấm điểm Writing & Speaking bằng <span className="text-blue-600">Trợ lí AI</span>
                            </h2>
                            <p className="text-lg text-slate-600 leading-relaxed">
                                Không còn phải chờ đợi giáo viên. Trợ lí AI sẽ phân tích bài làm của bạn trong tích tắc, chỉ ra lỗi sai ngữ pháp, từ vựng và gợi ý cách sửa để nâng band điểm nhanh chóng.
                            </p>
